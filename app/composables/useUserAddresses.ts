...
export const useUserAddresses = () => {
   ...
   */
  const setPrimaryAddress = async (addressId: string): Promise<{ success: boolean; error?: string }> => {
   ...
   */
  const validateAddressForm = (formData: AddressFormData): { valid: boolean; errors: string[] } => {
    const errors: string[] = []
