      ...
      >
        <div class="w-full rounded-t-3xl bg-white shadow-2xl overflow-hidden">
          ...
          >
            <!-- App icon -->
            <div
              class="w-14 h-14 rounded-2xl bg-[#0052CC] flex items-center justify-center shadow-lg flex-shrink-0"
            >
              <svg
          ...
          <div class="px-6 py-5 space-y-4">
            ...
            <div class="flex gap-4 items-start">
              <div
                class="w-9 h-9 rounded-full bg-blue-50 border border-blue-100 flex items-center justify-center flex-shrink-0 mt-0.5"
              >
                <!-- Share icon (iOS-style arrow up from box) -->
                <svg
                  class="w-5 h-5 text-[#0052CC]"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="2"
          ...
          <div class="px-6 pb-8">
            <button
              class="w-full rounded-2xl bg-blue-600 py-3.5 text-sm font-bold text-white hover:bg-blue-700 active:scale-[0.98] transition-all"
              @click="closeInstructions"
              type="button"
            >
              Got it
    ...
    <Transition name="banner">
      ...
      >
        <div class="mx-auto max-w-3xl px-4 py-3 flex items-center gap-3">
          <!-- App icon -->
          <div
            class="w-11 h-11 rounded-[12px] bg-blue-600 flex items-center justify-center flex-shrink-0 shadow"
          >
            <svg
          ...
          <div class="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              class="flex items-center gap-1.5 rounded-xl bg-blue-600 px-4 py-2 text-xs font-bold text-white hover:bg-blue-700 active:scale-95 transition-all shadow-sm"
