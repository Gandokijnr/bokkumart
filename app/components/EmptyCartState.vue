<template>
  <div class="flex flex-col items-center justify-center py-12 sm:py-16">
    <div
      class="mb-4 flex h-24 w-24 items-center justify-center rounded-full bg-gray-100 sm:mb-6 sm:h-32 sm:w-32"
    >
      <svg
    ...
    <p
      class="mb-6 max-w-md px-4 text-center text-sm text-gray-500 sm:mb-8 sm:text-base"
    >
    ...
    <div v-if="categories.length > 0" class="w-full max-w-4xl px-2">
      <h3
        class="mb-3 text-center text-base font-semibold text-gray-900 sm:mb-4 sm:text-lg"
      >
        Popular Categories
      </h3>
      <div
