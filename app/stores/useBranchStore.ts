...
/**
 * Branch Interface
 * Represents a HomeAffairs store/branch location
 */
...
export const useBranchStore = defineStore('branch', {
  ...
  getters: {
     ...
     * Get a branch by ID
     */
    getBranchById: (state) => (id: string): Branch | undefined => {
  ...
  actions: {
    ...
    async checkProductAvailability(
      ...
      try {
        ...
        return { available: false, quantity: 0, branchId: this.activeBranch.id }
      }
    },
