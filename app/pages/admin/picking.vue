                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-4">
                  ...
                  <div class="space-y-2">
                    ...
                    >
                      <div class="flex items-center gap-3">
                        <button
                          @click="toggleItemPicked(order.id, Number(idx))"
                        ...
                        >
                          <svg
                            v-if="isItemPicked(order.id, Number(idx))"
                            class="w-4 h-4"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                  ...
                  <div class="mt-4">
                    ...
                    >
                      ...
                      <span
                        >{{
                          getPickingProgress(order.id, order.items.length)
                        }}%</span
                      >
                    </div>
...
const completedTodayCount = computed(() => {
  ...
  return orders.value.filter(
    (o) => o.status === "delivered" && o.updated_at?.startsWith(today),
  ).length;
});
