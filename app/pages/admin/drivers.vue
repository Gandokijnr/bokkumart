        ...
        >
          <div>
            ...
            <p class="mt-1 text-sm text-gray-600">
              Monitor available/on_delivery/offline drivers and active
              deliveries.
            </p>
          </div>
      ...
      <div class="grid gap-6 lg:grid-cols-3">
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <p class="mt-1 text-xs text-gray-500">
            Available for dispatch when idle.
          </p>
        </div>
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
      ...
      >
        ...
        >
          <div>
            ...
            <p class="mt-1 text-xs text-gray-500">
              Realtime updates as drivers go available/on_delivery/offline.
            </p>
          </div>
            ...
            >
              <div class="min-w-0 flex-1">
                <div class="flex items-center gap-2 flex-wrap">
                  ...
                  <span
                    class="inline-flex rounded-full px-2 py-0.5 text-xs font-semibold truncate"
                    :class="
                      d.driver_status === 'available'
                ...
                <p
                  ...
                  :title="d.phone_number || 'No phone number'"
                >
                  {{ d.phone_number || "No phone number" }}
                </p>
    ...
    if (ids.length > 0) {
      ...
      for (const o of (orders || []) as any[]) {
        ...
        if (o.status === "delivered" && o.delivered_at) {
          ...
          if (t >= start && t < end) {
            deliveredTodayMap.set(
              driverId,
              (deliveredTodayMap.get(driverId) || 0) + 1,
            );
          }
        }
      }
