...
async function handleCall(order: AdminOrder) {
  ...
  if (order.customer?.phone_number) {
    callCustomer(order.customer.phone_number)
  }
}
            ...
            >
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                  ...
                  <span class="text-sm text-gray-600">{{ order.customer?.full_name || 'Unknown' }}</span>
          ...
          <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p class="text-base font-medium text-gray-900">{{ order.customer?.full_name || 'Unknown' }}</p>
              ...
              <div>
                ...
                <p class="text-sm text-gray-600">{{ formatCurrency(order.total_amount) }}</p>
                <p class="text-sm text-gray-600">{{ order.payment_method === 'cash_on_delivery' ? 'Cash on Delivery' : 'Online Payment' }}</p>
                <p class="text-sm text-gray-600 mt-1">{{ order.delivery_address?.street || 'No address' }}</p>
              </div>
