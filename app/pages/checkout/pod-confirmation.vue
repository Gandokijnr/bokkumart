  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="mx-auto max-w-2xl px-4 py-12 sm:px-6">
      <div class="text-center">
        ...
        <h1 class="mt-6 text-2xl font-bold text-gray-900">Order Pending Confirmation</h1>
        <p class="mt-2 text-gray-600">
          We'll call you shortly at <span class="font-bold">{{ orderPhone }}</span> to confirm your Pay on Delivery order.
        </p>
      </div>
      ...
      <div class="mt-8 rounded-xl border-2 border-gray-200 bg-white p-6">
        <div class="flex items-center justify-between mb-4">
          <h2 class="font-bold text-gray-900">Order #{{ orderId?.slice(-6) }}</h2>
      ...
      <div class="mt-6 rounded-xl border-2 border-blue-200 bg-blue-50 p-5">
        ...
        <div class="space-y-3 text-sm text-blue-800">
          <div class="flex items-start gap-3">
            <div class="flex h-6 w-6 items-center justify-center rounded-full bg-blue-200 flex-shrink-0 text-xs font-bold">1</div>
            <p>Our representative will call you within 30 minutes to confirm your order</p>
          </div>
          <div class="flex items-start gap-3">
            <div class="flex h-6 w-6 items-center justify-center rounded-full bg-blue-200 flex-shrink-0 text-xs font-bold">2</div>
            <p>Confirm your order details and delivery address with the representative</p>
          </div>
          <div class="flex items-start gap-3">
            <div class="flex h-6 w-6 items-center justify-center rounded-full bg-blue-200 flex-shrink-0 text-xs font-bold">3</div>
      ...
      <div class="mt-6 rounded-xl border-2 border-amber-200 bg-amber-50 p-4">
        <div class="flex items-start gap-3">
          ...
          <div class="text-sm text-amber-800">
            ...
            <p>Please ensure your phone is available. Orders not confirmed within 30 minutes will be automatically cancelled.</p>
          </div>
        </div>
      </div>
      ...
      <!-- Confirmation Modal -->
      <div v-if="isConfirmed" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
...
async function checkOrderStatus() {
  ...
  if (isConfirmed.value) {
    ...
    alert('Your order is still pending confirmation. Please wait for our call.')
  }
}
