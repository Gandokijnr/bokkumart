<template>
  <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="w-full max-w-md text-center">
      <!-- Lock Icon -->
      <div
        class="w-20 h-20 bg-blue-100 rounded-full mx-auto mb-6 flex items-center justify-center"
      >
        <svg
      ...
      <div class="space-y-3">
        ...
        <button
          v-if="user"
          @click="signOut"
          class="w-full py-3 px-4 text-blue-600 hover:bg-blue-50 font-medium rounded-xl transition-colors"
        >
          Sign Out
        </button>
      </div>
      ...
      <p class="mt-8 text-xs text-gray-500">
        ...
        <a href="tel:+23412345678" class="text-blue-600 hover:underline"
          >+234 1 234 5678</a
        >
      </p>
    </div>
